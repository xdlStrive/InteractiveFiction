...
// import { postArticleImg } from '@/api/article.js'
  ...
  methods: {
    ...
    initTinymce() {
      ...
      window.tinymce.init({
        ...
        plugins: plugins,
        content_style: 'p {text-indent: 2rem; letter-spacing: 0.5px;}',
        fontsize_formats: '12px 14px 16px 18pt 20px 24pt 36pt',
        ...
        images_upload_handler: async(blobInfo, succFun, failFun) => {
          ...
          // postArticleImg(formData).then(res => {
