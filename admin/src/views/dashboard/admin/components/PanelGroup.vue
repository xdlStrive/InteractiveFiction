<template>
  <el-row :gutter="40" class="panel-group">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="fetchData1()">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="currentCPUUtilization" :duration="1500" :decimals="2" :suffix="'%'" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
...
import { getCPUUtilizationLast } from '@/api/aly-api'
